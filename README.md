...
bashCopygit clone https://github.com/yourusername/SessionHijack.git
cd SessionHijack

Set up the database:
bashCopy# Create PostgreSQL database
...
Creates the authentication and session services
Registers HTTP routes for both the API and static files
